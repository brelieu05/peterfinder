      ...
      <div className="w-full max-w-md space-y-8 rounded-lg bg-white p-8 shadow dark:bg-zinc-900">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-zinc-600 dark:text-zinc-400">
            Only UCI email addresses (@uci.edu) are allowed
          </p>
        </div>
        ...
        <div>
          <button
            ...
            className="group relative flex w-full items-center justify-center rounded-md border border-zinc-300 bg-white px-3 py-2.5 text-sm font-semibold text-zinc-700 hover:bg-zinc-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-500 disabled:opacity-50 disabled:cursor-not-allowed dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700"
          >
            <GoogleIcon />
            {isGoogleLoading ? 'Redirecting...' : 'Sign in with UCI Google'}
          </button>
        </div>
          ...
          <div className="space-y-4 rounded-md shadow-sm">
            <div>
              ...
              <input
                ...
                placeholder="Email address (@uci.edu)"
              />
            </div>
            <div>
